    ...
    >
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                Contactez-moi dès aujourd'hui pour discuter de vos besoins et commencer à collaborer sur un projet exceptionnel !
            </p>
            ...
            <div className="flex items-center gap-2 mt-auto">
                {socialLinks.map (({ href, icon, }, key) =>(
                    ...
                    href={href}
                    target="_blank"
                    className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/50 rounded-lg transition-[background-color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                    >
                        {icon}
                    </a>
                ))}
       ...
       <form 
       action="https://getform.io/f/bvrrlyqb"
       method="POST"
